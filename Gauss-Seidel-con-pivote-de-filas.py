# -- coding: utf-8 --
"""
Created on Fri Oct 1 11:05:12 2021
@author: José Manuel Ramírez Olivera.
         Viviana Paloma Muñoz Sánchez.
         
Gauss Seidel con Pivoteo(Filas)
...
#Valor máximo por fila recorriendo columnas:
        maxM = np.argmax(colM)
#Método para intercambiar filas de mayor a menor, el cambio es con base en el máximo de cada fila: 
        if(maxM != 0):
            aux = np.copy(M[i,:])
            M[i,:] = M[maxM+i,:]
            M[maxM+i,:] = aux
...
#Imprimir valores:
print("Soluciones cambiando Filas: ", GS(A_np, b_np, 100000, 0.00001))